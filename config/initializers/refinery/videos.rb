Refinery::Videos.configure do |config|
    ...
    # config.dragonfly_secret = e21f76d669e6520ed2d50c8c322f801242ce5ce9f9d2b782
    # If you decide to trust file extensions replace :ext below with :format
    # config.dragonfly_url_format = /system/videos/:job/:basename.:format
    # config.datastore_root_path = /Users/andylinteau/rails_projects/andysblog/public/system/refinery/videos
